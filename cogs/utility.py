...
class utility(commands.Cog):
    ...
    """
        ...
        embed = discord.Embed(color=self.bot.color, escription=f"[webp]({str(member1.avatar_url_as(format='png'))}) [jpeg]({str(member1.avatar_url_as(format='jpeg'))}) [png]({str(member1.avatar_url_as(format='png'))})" if not ctx.author.is_avatar_animated() else f"[webp]({str(member1.avatar_url_as(format='png'))}) [jpeg]({str(member1.avatar_url_as(format='jpeg'))}) [png]({str(member1.avatar_url_as(format='png'))}) [gif]({str(member1.avatar_url_as(format='gif'))})")
