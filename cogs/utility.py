...
class utility(commands.Cog):
    ...
    async def google_(self, thing, ctx):
        ...
        async with self.bot.session.get(f"https://google.com/search?q={thing}", headers={"User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.82 Safari/537.36"}) as resp:
            results = []
