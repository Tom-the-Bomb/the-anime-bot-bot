...
class pictures(commands.Cog):
    ...
    def facereg_(self, image):
        ...
        haar_face_cascade = cv2.CascadeClassifier("/usr/local/lib/python3.9/site-packages/cv2/data/haarcascade_frontalface_alt2.xml")
        faces = haar_face_cascade.detectMultiScale(gray_img, scaleFactor=1.001, minNeighbors=5)
